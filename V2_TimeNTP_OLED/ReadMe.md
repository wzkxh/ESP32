...
- reads weather (temperature only) from open-meteo.com every 15 minutes

TODO: detect and process WiFi disconnection - reconnect; make async fetch

![ESP32 clock with NTP sync and weather from internet](20260525-2034.webp)
